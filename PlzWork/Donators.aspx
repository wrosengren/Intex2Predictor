<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Donators.aspx.cs" Inherits="PlzWork.Donators" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Donators Predictor</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h3>
                <asp:HyperLink ID="HyperLink1" NavigateUrl="Money.aspx" runat="server">Donation Predictor</asp:HyperLink>
                <br />
